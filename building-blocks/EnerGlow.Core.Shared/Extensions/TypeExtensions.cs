...
namespace EnerGlow.Core.Shared.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        /// <summary>
        /// 获取指定属性的DescriptionAttribute说明
        /// </summary>
        /// <param name="property"></param>
        /// <returns></returns>
        public static string GetDescriptionName(this PropertyInfo property)
        {
            if (property.IsDefined(typeof(DescriptionAttribute), false))
            {
                var attribute = (DescriptionAttribute)property.GetCustomAttribute(typeof(DescriptionAttribute), false);
